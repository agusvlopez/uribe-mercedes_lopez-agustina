    ...
    public function run(): void
    {
         ...
         DB::table('entradas_blog')->insert([
            [
                ...
                'author' => 'Ana Perez',
                'cover' => 'coversEntrada/blog-frutas_estacion.jpg',
                'cover_description' => 'Frutas en una bolsa de red.',
                'created_at' => now(),
                'updated_at' => now()
            ],
            [
                ...
                'author' => 'Ana Perez',
                'cover' => 'coversEntrada/blog-garbanzos.jpg',
                'cover_description' => 'Garbanzos en un plato.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'author' => 'Ana Perez',
                'cover' => 'coversEntrada/blog-contar_calorias.jpg',
                'cover_description' => 'Manzana con centímetro.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
