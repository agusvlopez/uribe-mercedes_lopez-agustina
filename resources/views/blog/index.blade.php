    ...
    <div class="row">
        <div class="p-4 fs-5">
            ...
            <div class="d-md-flex mb-3 justify-content-center">
                ...
                <div class="nav-link me-3"><a class="text-decoration-none link" href="{{route('blog.clasification.view', ['id' => $clasification->clasification_id]   )}}">{{$clasification->name}}</a></div>
                @endforeach
            </div>
